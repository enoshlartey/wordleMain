...
from .forms import sixLetterWordForm
...
new_answer_word = answer_word.word(word_min_length=6, word_max_length=6)
...
def indexView(request):
    ...
    if request.method == "POST":
        input_form = sixLetterWordForm(request.POST)
        if input_form.is_valid():
            ...
            letter_six = input_form.cleaned_data.get("letterSix")

            guess_list = [letter_one, letter_two, letter_three, letter_four, letter_five, letter_six]
